...
- `scrim`: Creates a voting for an internal scrim 12p 6v6 with options _can_ (✅) and _can't_ (❌) for a given date.
- `vod-review`: Creates a voting for an VOD review with options _can_ (✅) and _can't_ (❌) for a given date.
